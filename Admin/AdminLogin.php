    ...
    <div class="container-fluid Register-wrapper py-5">
      ...
      <div class="col-md-7">
        <div class="container bg-light py-3 rounded">
          ...
          <form action="AdminHome.php" method="post" class="g-3">
            <div class="col mt-2">
              <label class="form-label" for="">Email</label>
              <input class="form-control"type="email" name="AdminEmail" value="">
            </div>
            <div class="col mt-2">
...
<?php
  if (isset($_post['button'])) {
    ...
    if($User == 'Admin@abc.com' && $Password == '1231'){
      echo "<script>windows.location.href = 'AdminHome.php'</script>";
    }
    else {
